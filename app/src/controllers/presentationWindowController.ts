...
import { csvToObject, shuffle } from '../utils/commonUtils';
import { notSelectedScoreMessage } from '../utils/alert/alertMessages';
import {
  getNumberOfBreaks,
  ...
  finishExperiment,
  disableRatingInputs,
} from '../utils/window/presentationWindowUtils';
import SubjectiveExperiment from '../Models/SubjectiveExperiment';
import Player from '../Models/Player';
import Score from '../Models/Score';
import subjectiveExperiments from '../staticData/subjectiveExperimentsData';
